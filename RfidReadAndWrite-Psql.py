...
sysdict={'ts':1,'ss':30,'a1':1,'a2':0,'a3':0,'a4':0,'aw':3000,'sip1':'192.168.0.188','sip2':'','sip3':'','sip4':''}
pool = None
redisconnpool = None
...
e=EmbeddedCom.ComCOMThread(Port='/dev/ttyAMA4',baudrate=115200,timeout=0.1,RCallarg=rfidcallbackdata,ReceiveCallBack=comrecvcallbackpross)
tag22rev=0
tag29rev=0
